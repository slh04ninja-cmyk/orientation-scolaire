...
with st.sidebar:
    ...
    # ✅ CORRECTION: avertir si les seuils sont égaux ou non discriminants
...
if selected:
    ...
    with d2:
        # ✅ CORRECTION CRITIQUE: utiliser l'index original d'averages
        # L'ancien code : idx_student = results[results["Eleve"] == selected].index[0] - 1
        # causait un décalage car results.index = Rang (1,2,3...) trié par score
        # et averages.index = index original du fichier Excel (non trié)
